    ...
    <div>
      ...
      <section id="actualites" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* News Item 1 */}
            <Card className="bg-gray-50 shadow-lg card-hover border-none overflow-hidden">
              <img 
                ...
                alt="Students collaborating in group study session" 
              ...
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-neutral mb-3">
                  Nouveau Programme de Soutien Scolaire
                </h3>
                <p className="text-gray-600 mb-4">
                  Lancement de notre nouveau programme intensif de soutien scolaire pour les élèves du collège et lycée, avec des sessions individualisées.
                </p>
            ...
            <Card className="bg-gray-50 shadow-lg card-hover border-none overflow-hidden">
              <img 
                ...
                alt="Professional workshop training session with participants" 
                className="w-full h-48 object-cover"
              />
              <CardContent className="p-6">
                <div className="flex items-center space-x-2 text-sm text-gray-500 mb-3">
                ...
                <h3 className="text-xl font-semibold text-neutral mb-3">
                  Atelier d'Artisanat Traditionnel Marocain
                </h3>
                <p className="text-gray-600 mb-4">
                  Une session exceptionnelle d'apprentissage des techniques artisanales traditionnelles avec des maîtres artisans locaux.
                </p>
                <Button variant="link" className="text-primary p-0">
                  {t('news.readMore')}
                </Button>
            ...
            <Card className="bg-gray-50 shadow-lg card-hover border-none overflow-hidden">
              <img 
                src="https://images.unsplash.com/photo-1511632765486-a01980e01a18?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=400" 
                alt="Community celebration event with participants celebrating achievements" 
                className="w-full h-48 object-cover"
              />
              <CardContent className="p-6">
                <div className="flex items-center space-x-2 text-sm text-gray-500 mb-3">
                ...
                <p className="text-gray-600 mb-4">
                  Félicitations à nos 50 diplômés qui ont terminé avec succès leurs formations en alphabétisation et compétences professionnelles.
                </p>
                <Button variant="link" className="text-primary p-0">
                  {t('news.readMore')}
                </Button>
          ...
          <div className="text-center mt-12">
            <Button className="bg-primary text-white px-8 py-4 hover:bg-blue-700">
              {t('news.viewAll')}
            </Button>
          </div>
        </div>
